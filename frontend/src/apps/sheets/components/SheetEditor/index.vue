...
.sn-slicer      { position:fixed; z-index:8400; width:200px; background:var(--surface-elevation-2); border:1px solid var(--outline-elevation-2); border-radius:10px; box-shadow:0 4px 16px rgba(0,0,0,.14); display:flex; flex-direction:column; overflow:hidden; }
.sn-slicer-head { display:flex; align-items:center; justify-content:space-between; gap:8px; padding:6px 8px 6px 12px; background:var(--surface-gray-2, #f4f4f4); border-bottom:1px solid var(--outline-elevation-2); cursor:move; user-select:none; }
